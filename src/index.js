...
function Main() {
  ...
  return <div style={{letterSpacing:"2px"}} className="bg-gray-200 rounded-3xl shadow-2xl p-4 flex flex-wrap">
    {(() => {
      switch (tab) {
        case "login":
          return <>
        ...
        case "send":
          return <div className='flex flex-wrap w-[600px]'>
            <div className="flex relative items-center w-full bg-white p-4 shadow-md rounded-xl">
            ...
            <div className='w-full my-4 flex flex-wrap'>
              <div className='flex flex-wrap w-full pt-4'>
                ...
                <select defaultValue={null} id="panic-type" className='text-center w-full bg-white p-2 rounded-md'>
              ...
              <div className='flex flex-wrap w-full pt-4'>
                ...
                <textarea id="panic-details" placeholder='enter details' className='text-center w-full p-2 rounded-md focus:outline-none' type="text" style={{resize:"none"}}/>
              </div>
            </div>
            ...
            <div className='w-full mt-4 h-[400px] overflow-auto flex flex-wrap'>
              {tempData && tempData.map((item,key)=>{
                return <div key={`panic-item-${key}`} className='bg-for-table w-full flex-wrap p-4' >
                  <div className='my-1 flex flex-wrap w-full' style={{ borderBottom: "2px dotted #CCC" }}>
                    <div className='w-1/2'>
                      Type
                    </div>
                    <div className='w-1/2'>
